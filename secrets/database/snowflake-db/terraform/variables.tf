...
variable "admin_ssh_cidr" {
  description = "CIDR allowed to SSH to the Vault node and reach the Vault API on port 8200."
  type        = string
}
...
variable "ami_architecture" {
  description = "AMI architecture to resolve when ami_id is null."
  type        = string
  default     = "x86_64"
