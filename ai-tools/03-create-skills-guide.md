...
- [Document Reference Skill Template](../ai-tools/.bob/skills/document-reference/SKILL.md)
...
- one folder per skill: `customer-reply/`, `document-reference/`, `find-vault-bugs/`
